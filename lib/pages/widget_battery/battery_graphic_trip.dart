...
class BatteryGraphicTrip extends StatefulWidget {
  @override
  State<BatteryGraphicTrip> createState() => _BatteryGraphicTripState();
}

class _BatteryGraphicTripState extends State<BatteryGraphicTrip> {
